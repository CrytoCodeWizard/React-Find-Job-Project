...
const Hero = () => {
    ...
    return (
      ...
      <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12 mt-2  items-center'>
          ...
          <img src="https://i.ibb.co/R3NVhbf/clint-patterson-d-YEu-FB8-KQJk-unsplash.jpg" class="w-90 shadow-5xl" />
          </div>
    ...
    <button className='btn mt-6 font-white'>Get Started</button>
